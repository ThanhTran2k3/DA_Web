        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    danhSachPhat.Name = "YeuThich";
                    danhSachPhat.User = user;
                    var tl_DanhSach = await _context.TL_DanhSach.FindAsync(3);
                    danhSachPhat.TL_DanhSach = tl_DanhSach;
                    _context.DanhSachPhat.Add(danhSachPhat);
